...
import 'package:flutter_ollama_ai/controllers/ollama_controller.dart';
import 'package:flutter_ollama_ai/models/chatbot_model.dart';

void main() => runApp(const OllamaAiApp());

class OllamaAiApp extends StatelessWidget {
  const OllamaAiApp({super.key});
